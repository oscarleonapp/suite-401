  ...
  <div class="docs-home-wr">
    ...
    <div class="docs-home">
      ...
      <div class="providerslist">
        <div class="provimg"><a href="providers-ruane.php"><img src="images/Peter-Ruane-MD.jpg" alt="Peter J. Ruane, MD" width="100%" /></a></div>
        <p><a href="providers-ruane.php#top">Peter J. Ruane, MD</a></p>
      </div>

      <!-- A Doc -->
      <div class="providerslist">
        <div class="provimg"><a href="providers-wolfe.php"><img src="images/Peter-Wolfe-MD.jpg" alt="Peter R. Wolfe, MD" width="100%" /></a></div>
        <p><a href="providers-wolfe.php#top">Peter R. Wolfe, MD</a></p>
      </div>

      <!-- A Doc -->
      <div class="providerslist">
        <div class="provimg"><a href="providers-trinidad.php"><img src="images/Kenny-Trinidad-PA-C.jpg" alt="Kenny Trinidad PA-C" width="100%" /></a></div>
        <p><a href="providers-trinidad.php#top">Kenny Trinidad PA-C</a></p>
      </div>
		<!-- A Doc -->
      <div class="providerslist">
        <div class="provimg"><a href="providers-matthewmusikanth.php"><img src="images/Matthew-Musikanth-PA-C-portrait.jpg" alt="Phillip A. Musikanth, MD" width="100%" /></a></div>
        <p><a href="providers-musikanth.php#top">Matthew Musikanth PA-C</a></p>
      </div>
</div>
...
<div class="docs-home">
      ...
      <!-- A Doc -->
      <div class="providerslist">
        <div class="provimg"><a href="providers-drv.php"><img src="images/Koppany-Visnyei-MD.jpg" alt="Koppany Visnyei, MD PhD" width="100%" /></a></div>
        <p><a href="providers-drv.php#top">Koppany Visnyei, MD PhD</a></p>
      </div>
      
      <!-- A Doc -->
      <div class="providerslist">
        <div class="provimg"><a href="providers-asia-sullivan.php"><img src="images/images/Asia-Sullivan-PA-C_s2_01.jpg" alt="Koppany Visnyei, MD PhD" width="100%" /></a></div>
        <p><a href="providers-asia-sullivan.php">Asia Sullivan PA-C</a></p>
      </div>
    
    <!-- A Doc -->
      <div class="providerslist">
        <div class="provimg"><a href="providers-jake-collins.php"><img src="images/Jake-photo-2-small.jpg" alt="Jake Collins PA-C" width="100%
            " /></a></div>
        <p><a href="providers-jake-collins.php#top">Jake Collins PA-C</a></p>
      </div>
