...
<title>Jamal Bracken PA-C | Medical Office</title>
<!-- InstanceEndEditable -->
  ...
  <div class="providerprofile-wr">
    <div class="providerprofile">
      <div class="provider-imgbox">
        <p><img src="images/Jamal-Bracken-PA-C.jpg" alt="Jamal Bracken PA-C" width="100%" /></p>
        <p>&nbsp;</p>
        <!--<p><a class="acceptedins" href="#">Accepted Health Plans</a>      </p>-->
        <!--<p><a class="book-but" href="appointment.php#top">Request appointment with Jamal</a></p>-->
      </div>
      <div class="provider-textbox">
        <h1>Jamal T. Bracken, PA-C, MSHS, MS</h1>
        <p>&nbsp;</p>
        <h2>Specialty areas:</h2>
        <p>Primary Care/Internal Medicine</p>
        <p>Preventative Medicine (Nutrition, Fitness, and Wellness)        </p>
        <p>Psychiatry </p>
        <p>Infectious Diseases including HIV/AIDS </p>
        <p>STD Testing and Treatment </p>
        <p>PrEP/PEP </p>
        <p>LGBTQ and Sexual Health</p>
        <p>&nbsp;</p>
        <h2>Accepting new patients: </h2>
        <p>NOT ACCEPTING PATIENTS AT THIS TIME</p>
        <p>&nbsp;</p>
        <h2>Bio:</h2>
        <p>Jamal T. Bracken started his career in healthcare in 2010 working in nutrition, fitness, and patient education. Originally from Baltimore, Maryland, he graduated with honors from Frostburg State University with a Bachelor's of Science in Health Science. During his undergraduate studies, he was a student-athlete basketball player. Jamal graduated from Towson University with a Master's of Science in Community Health and Health Education. During his graduate studies, he was elected the College of Health Professions graduate student representative and accepted into Delta Kappa Omicron, Leadership Fraternity. Jamal completed his academic career at University of Maryland, where he earned a Master's in Physician Assistant Studies. His graduate studies were concentrated in Preventative Medicine (Health, Wellness, Nutrition, and Exercise), Primary Care and HIV medicine.   </p>
        <p>&nbsp;</p>
        <p>Jamal is passionate about patient-centered care and patient education. In his spare time, Jamal enjoys reading, basketball, tennis, hiking, listening to music, spending time with family and friends, and relaxing at the beach.   </p>
        <p>&nbsp;</p>
        <p>Jamal is also a Certified Personal Trainer and Nutrition Coach. </p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
      </div>
    </div>
