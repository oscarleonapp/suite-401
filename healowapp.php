...
<div>
<div class="portalbanner-wr"><div class="portalbanner">
<a class="portalbutton" href="https://healow.com/apps/healow/download.jsp?key=dIFu8dveFGwmEOsHVWa_QHBVG5Qs4yBT">App Store</a>  <h1>Healow App</h1>
</div></div>
<div class="conttop">&nbsp;</div>
<div class="cont-wr">
  <div class="cont cont650">
<h1>All about the Healow App</h1>
                <p>&nbsp;</p>
                <p>The Healow App is a <strong>free app</strong> that allows you to see most of the information that you see in the Patient Portal. It is available in the <a href="https://healow.com/apps/healow/download.jsp?key=dIFu8dveFGwmEOsHVWa_QHBVG5Qs4yBT">App Store</a> and the <a href="https://play.google.com/store/apps/details?id=com.ecw.healow">Google Play Store</a>. </p>
      <h2>1. Difference between the portal and the app</h2>
                <p>We've found that many patients prefer the app to the portal. The two main benefits of the app is that it is very easy to access (it is always there in your phone), and that you can log in using a 4 digit pin (no username and password necessary once you've set it up).                </p>
                <h2>2. Logging in the app</h2>
                <p>Your initial <strong>username</strong> and a <strong>password</strong> to log in to Healow is the same as the <a href="patientportal.php">Patient Portal</a>. These have been given to you on your visit to our office. If you have not received these, please call our front desk (323 954 1072). We will set up a new username and password for you.</p>
                <p>1. Open the Healow App and click &quot;Search&quot;</p>
                <p><img src="images/healow-1.gif" width="230" height="404" /></p>
                <p>2. Write DAGJBA into the search field:</p>
                <p><img src="images/healow-2.gif" width="230" height="404" /></p>
                <p>3. Click on &quot;Dr Ruane Wolfe Gottlieb Musikanth&quot;</p>
                <p><img src="images/selection.gif" width="315" height="61" alt="selection" /></p>
                <p>&nbsp;</p>
                <p>4. If this is the first time you log in and have not yet logged in using the <a href="patientportal.php">Patient Portal</a>, you will be asked to reset the default password we gave you at your visit. You will also be asked to set up a security question which will help you in the future if you forget your password:</p>
                <p><img src="images/healow-passw.jpg" width="231" height="406" alt="healow-pass" /></p>
                <p>&nbsp;</p>
                <p>5. And finally, the really convenient part. You will be asked to set a 4 digit pin. Once you set this up you will always be able to log in using just the 4 digit pin - no need to remember user names and passwords:</p>
                <p><img src="images/healow-pin.jpg" width="231" height="406" alt="pin" /></p>
                <p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
