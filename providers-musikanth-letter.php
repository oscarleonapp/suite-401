...
<link href="css/global-12.css" rel="stylesheet" type="text/css" />
...
<div>
  <div class="providerprofile-wr">
    <div class="providerprofile">
      <div class="provider-imgbox">
        <p><img src="images/Phillip-Musikanth-MD.jpg" width="100%" /></p>
        <p>&nbsp;</p>
        <!--<p><a class="acceptedins" href="#">Accepted Health Plans</a>      </p>--><!--<p><a class="book-but" href="appointment.php#top">Request appointment with Dr. Musikanth</a></p>-->
      </div>
      <div class="provider-textbox">
        <h1>Letter to Patients from Dr. Phillip Musikanth, MD</h1>
        <p>&nbsp;</p>
        <p>Re: Important Announcement: My Retirement and Transition of Care</p>
        <p>&nbsp;</p>
        <p>Dear Patient,</p>
        <p><br />
          I hope this message finds you well. I am writing to share  some important news: I will be retiring from my practice in Suite 401 on&nbsp;<strong>January  15th, 2025</strong>.<br />
        </p>
        <p>&nbsp;</p>
        <p>As previously mentioned,&nbsp;<strong>Dr. Ruane</strong>&nbsp;and his  team—<strong>Kenny Trinidad, PA-C</strong>, and now my nephew,&nbsp;<strong><a href="providers-matthewmusikanth.php">Matthew&nbsp;Musikanth,  PA-C</a></strong>—will be taking over your care. They are committed to providing the  same level of dedication and compassion that you have come to expect.<br />
        </p>
        <p>&nbsp;</p>
        <p><strong>Transition Details and New Practice Policies</strong><br />
          To ensure a smooth transition, here are a few important  points regarding the new practice policies:</p>
        <p>&nbsp;</p>
        <ol start="1" type="1">
          <li><strong>Appointment       Scheduling</strong>:<br />
          You will be able to schedule appointments with Dr. Ruane's team by calling       the office or requesting&nbsp;an appointment using the patient portal or       Healow app.</li>
        </ol>
        <ol start="2" type="1">
          <li><strong>Dr.       Ruane's Team Office Visit Schedule</strong>:</li>
        </ol>
        <ol start="2" type="1">
          <ul type="circle">
            <li><strong>Kenny        Trinidad, PA-C</strong>: Monday through Friday, 9:00 am to 4:30 pm</li>
          </ul>
        </ol>
        <ol start="2" type="1">
          <ul type="circle">
            <li><strong>Matthew&nbsp;Musikanth,        PA-C</strong>: Monday through Friday, 8:00 am to 4:30 pm (Appointments        available from November 1st, 2024)</li>
          </ul>
        </ol>
        <ol start="2" type="1">
          <ul type="circle">
            <li><strong>Dr.        Peter Ruane</strong>: Tuesday, Thursday, and Friday, 2:00 pm to 4:30 pm (Dr.        Ruane is scheduled in the office 5 days a week as the supervising        physician for the Physician Associates in both the Clinic and the        Research office)</li>
          </ul>
        </ol>
        <ol start="2" type="1">
          <li><strong>Insurance       and Billing</strong>:<br />
            Dr. Ruane's practice will continue to accept most of the same insurance       plans. If you have specific questions about your coverage, the billing       department is available to assist you.</li>
        </ol>
        <ol start="4" type="1">
          <li><strong>Prescription       Refills</strong>:<br />
          For ongoing prescriptions, please coordinate with the new team, who will       have access to your medical history. They may request that you schedule a       visit to discuss your treatment and refills.</li>
        </ol>
        <ol start="5" type="1">
          <li><strong>Continuity       of Care</strong>:<br />
            Dr. Ruane's team is dedicated to understanding your health needs. If you       have any special concerns or preferences, please communicate them during       your initial visits.</li>
        </ol>
        <ol start="6" type="1">
          <li><strong>FAQs</strong>:       please visit the Suite 401 website for more&nbsp;information at&nbsp;<a href="https://www.suite401.com/providers-musikanth-faqs.php" target="_blank">https://www.suite401.com/providers-musikanth-faqs.php</a></li>
        </ol>
        <p>&nbsp;</p>
        <p>Deciding to retire has not been an easy choice for me.  Practicing medicine has been my passion for as long as I can remember, and I  have cherished every moment spent caring for you and your families. Your trust  and confidence in me have meant the world to me, and each of you has touched my  life in unique ways. I will carry those wonderful memories and valuable lessons  with me always.<br />
        </p>
        <p>&nbsp;</p>
        <p>If you have any questions or concerns, please don&rsquo;t hesitate  to reach out to me or my office before&nbsp;<strong>January 15th, 2025</strong>. I want  to ensure this transition is as smooth as possible for you.<br />
        </p>
        <p>&nbsp;</p>
        <p>Thank you for allowing me to be a part of your health  journey.<br />
          Wishing you good health and happiness,<br />
        </p>
        <p>&nbsp;</p>
        <p><strong>Phillip&nbsp;Musikanth, M.D.</strong><br />
          5901 W. Olympic Blvd., Suite 401<br />
          Los Angeles, CA 90036<br />
          T: 323.525.1101 | F: 323.954.1081<br />
        </p>
        <p>&nbsp;</p>
        <p><strong>Dr. Ruane's Team:</strong></p>
        <p><img border="0" width="100%" src="file://///rm-dc02/RedirectedFolders/vschmidt/Documents/suite401-web/img/DrRuaneTeam.png" alt="A collage of men wearing medical uniforms  Description automatically generated" /></p>
        <p><br />
        </p>
        <p>&nbsp; </p>
        <p>&nbsp;</p>
