  ...
  <div class="providerprofile-wr">
    <div class="providerprofile">
      ...
      <div class="provider-textbox">
        <h1>FAQs relating to Dr. Musikanth's retirement on January 15, 2025</h1>
        <p>&nbsp;</p>
        <h4>1. Who will take over my care?</h4>
        <p>Dr. Musikanth has recommended that your care be transitioned to Dr. Peter Ruane and his team, including Physician Associates Kenny Trinidad, PA-C, and <a href="providers-matthewmusikanth.php">Matthew Musikanth, PA-C</a>. They are fully qualified and committed to providing the same high level of care you have come to expect.</p>
        <p>&nbsp;</p>
        <h4>2. Will they have my medical records?</h4>
        <p>Yes, all of your medical records will be available to them in the same EMR (Electronic Medical Records) system used by Suite401 Medical.</p>
        <p>&nbsp;</p>
        <h4>3. Will I need to schedule a new appointment with the new provider?</h4>
        <p>You may need to schedule a new appointment, but the staff will help facilitate this transition.</p>
        <p>&nbsp;</p>
        <h4>4. Can I still see my current doctor before they leave?</h4>
        <p>Yes, if appointments are available, you can see Dr. Musikanth before his retirement on January 15, 2025.</p>
        <p>&nbsp;</p>
        <h4>5. What if I don&rsquo;t feel comfortable with the new provider?</h4>
        <p>It's important to feel comfortable with your healthcare provider. You can discuss any concerns with the staff, who will help you find a provider that suits your needs.</p>
        <p>&nbsp;</p>
        <h4>6. Will my insurance still be accepted?</h4>
        <p>Most likely, but it&rsquo;s best to check with the office to confirm accepted insurance plans.</p>
        <p>&nbsp;</p>
        <h4>7. Will there be any changes to my billing or payment procedures?</h4>
        <p>Billing procedures should remain similar as long as Dr. Ruane is in-network with your insurance. He is listed as a specialist with most insurance plans, which may affect your copay. You can check any differences during your appointment or review your statement. Feel free to check with your insurance plan before making an appointment.</p>
        <p>&nbsp;</p>
        <h4>8. How will my treatment plans be managed during the transition?</h4>
        <p>The providers will review your treatment history to ensure a seamless transition of care.</p>
        <p>&nbsp;</p>
        <h4>9. What if I have ongoing treatments or prescriptions?</h4>
        <p>The providers will continue any ongoing treatments and prescriptions as necessary. They may request that you schedule a visit to discuss your treatment and any prescription refills.</p>
        <p>&nbsp;</p>
        <h4>10. What should I do if I need care immediately after my doctor retires?</h4>
        <p>Contact the office, and they will assist you with any immediate care needs. There will always be a doctor on call to help.</p>
        <p>&nbsp;</p>
        <h4>11. Will the providers be available for all types of care I need?</h4>
        <p>Dr. Ruane&rsquo;s team is equipped to handle most of the same services, but it&rsquo;s a good idea to confirm any specific needs with their office.</p>
        <p>&nbsp;</p>
        <h4>12. What if I feel anxious about this change?</h4>
        <p>It&rsquo;s natural to feel anxious about change. Don&rsquo;t hesitate to discuss your concerns with Dr. Ruane&rsquo;s team.</p>
        <p>&nbsp;</p>
        <h4>13. If I want to see another doctor outside Suite401 Medical, will my medical records be transferred?</h4>
        <p>Yes, upon request, all medical records will be securely transferred to your new provider to ensure continuity of care. You can send us a portal message with the transfer details or email us at <a rel="noopener">info@suite401medical.com</a>.</p>
        <p>&nbsp;</p>
        <h4>14. Can the providers in Dr. Ruane&rsquo;s team prescribe or refill controlled substances?</h4>
        <p>Yes, they can prescribe and refill controlled substances. However, their office policy requires patients to schedule an office visit every 3 months for continued prescriptions.</p>
        <p>&nbsp;</p>
