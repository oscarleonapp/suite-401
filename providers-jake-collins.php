...
<div>
  <div class="providerprofile-wr">
    <div class="providerprofile">
      <div class="provider-imgbox"><img src="images/Jake-Collins-PA-C.jpg" alt="Jake Collins PA-C" width="100%" />
      <!--<p><a class="acceptedins" href="#">Accepted Health Plans</a>      </p>-->
      <p><a class="book-but" href="https://www.suite401.com/appointment.php#top">Book appointment with Jake</a></p></div>
      <div class="provider-textbox">
        <h1>Jake Collins PA-C</h1>
        <p>&nbsp;</p>
...
<p>&nbsp;</p>
        ...
        <p>&nbsp;</p>
        <h2>About Jake</h2>
        <p>Jake grew up in Dacula, Georgia. After receiving a BS in Psychology at the University of Georgia, he received a Master of Public Health from the University of Arizona. He then moved to Los Angeles, where he worked for several nonprofits serving the LGBTQ community. While working in HIV clinical research, he discovered a passion for patient care. He attended the MEDEX Northwest Physician Assistant Training Program at the University of Washington, graduating in 2019. Prior to joining Dr V Medical at Suite 401 Medical Office, he worked in clinical orthopedics. His interests include music, fitness, and traveling. </p>
        <div>
          <div>
            <div>
              <div> </div>
