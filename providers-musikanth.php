  ...
  <div class="providerprofile-wr">
    <div class="providerprofile">
      ...
      <div class="provider-textbox">
        <h1>Dr. Phillip Musikanth, MD</h1>
        <p>&nbsp;</p>
        <p>October 2024 Update:</p>
        <p>&nbsp;</p>
        <div>Letter to patients: <a href="https://www.suite401.com/providers-musikanth-letter.php" id="LPlnk">https://www.suite401.com/providers-musikanth-letter.php</a></div>
        <div><br />
        </div>
        <div>FAQs: <a href="https://www.suite401.com/providers-musikanth-faqs.php" id="LPlnk">https://www.suite401.com/providers-musikanth-faqs.php</a></div>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <h2>Specialty areas:</h2>
        <p>Internal Medicine and HIV        </p>
        <p>&nbsp;</p>
        <p>Dr. Musikanth has been practicing medicine since 1986. Known for his genuine commitment, compassion and expertise, his journey began in his home land, South Africa. </p>
        <p>&nbsp;</p>
        <p>Dr. Musikanth's medical practice is focusing on General Internal Medicine and HIV / AIDS. He has been involved in various clinical trials for new HIV treatments as both principle and sub investigator.</p>
        <p>&nbsp;</p>
        <h2>Education: 
        </h2>
        <ul>
          <li>            LAC-USC MEDICAL CENTER - Residency - Internal Medicine          </li>
          <li>            UNIVERSITY OF CAPE TOWN - Bachelor Of Medicine, Bachelor Of Surgery          </li>
          <li>            UNIVERSITY OF CAPE TOWN - Bachelor Of Science in Microbiology</li>
        </ul>
        <p>&nbsp;</p>
        <p>Website: <strong><a href="http://www.phillipmusikanthmd.com/">www.phillipmusikanthmd.com</a></strong></p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
      </div>
    </div>
