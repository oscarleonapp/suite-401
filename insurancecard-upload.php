...
<!-- InstanceEndEditable -->
<!-- InstanceParam name="idtag" type="text" value="insuranceupload" -->
</head>

<body id="insuranceupload">
...
<div class="homecont-wr">
    <div class="homecont"><div align="center"><img src="images/insurance-card-for-form-mob.jpg" width="300" height="200" alt="insurance card upload" />
    <p>&nbsp;</p>
    <p class="note">(It might take a few seconds for the insurance card form to appear below:)</p>
    <p class="note">&nbsp;</p>
    <p class="note"><strong>iPhone users</strong>: we noticed that some iPhone users were not able to submit this form. </p>
    <p class="note">If you encounter this issue, please email the photo to <b><SCRIPT TYPE="text/javascript">
  document.write('info@' + 'suite401.com')
</SCRIPT></b>. Thank you! :)</p>
    </div><!-- www.123formbuilder.com script begins here --><script type="text/javascript" defer src="https://www.123formbuilder.com/embed/4358046.js" data-role="form" data-default-width="650px"></script><!-- www.123formbuilder.com script ends here -->
    </div></div>
<!-- InstanceEndEditable -->
<div class="footerwr">
  <div class="footer">
