...
<style>
:root{
  --primary:#0b4864;           /* azul oscuro botón normal */
  --primary-hover:#07364a;     /* azul más oscuro hover */
  --text:#123;                 /* títulos */
  --body:#6b6f75;              /* párrafos */
  --border:#dfe6eb;
...
/* separador horizontal entre las dos filas (opcional) */
.docs__divider{
  grid-column:1/-1;
  height:1px;
...
<div class="homecont-wr">
  ...
  <div class="docs__grid">
    ...
    <article class="doc-item">
      <h2>Drv Medical</h2>
      <p>This policy outlines our clinic’s policies.</p>
      <a class="btn" href="https://www.drvmedical.com/policies" target="_blank">Policies</a>
    </article>

    <!-- 2 -->
     <article class="doc-item">
      <h2>Dr. Peter Ruane</h2>
      <p>This policy outlines our clinic’s policies.</p>
      <a class="btn" href="policies.php">Policies</a>
    </article>

    <!-- <div class="docs__divider" aria-hidden="true"></div> -->
