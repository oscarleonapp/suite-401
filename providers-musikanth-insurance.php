  ...
  <div class="providerprofile-wr">
    <div class="providerprofile">
      <div class="provider-imgbox">
        <p><img src="images/provider-musikanth.gif" width="100%" /></p>
        <p>&nbsp;</p><p><a class="book-but" href="appointment.php#top">Request appointment with Dr. Musikanth</a></p>
      </div>
      <div class="provider-textbox">
        <h1>Insurance that Dr. Phillip Musikanth, MD accepts in his practice</h1>
        <p>&nbsp;</p>
        <h2>&nbsp;</h2>
<h2>&nbsp;</h2>
<p>&nbsp;</p>
