...
<div>
  <div class="providerprofile-wr">
    <div class="providerprofile">
      <div class="provider-imgbox"><img src="images/Koppany-Visnyei-MD.jpg" width="100%" />
      <!--<p><a class="acceptedins" href="#">Accepted Health Plans</a>      </p>--><p><a class="book-but" href="https://www.drvmedical.com/index.php#appointment">Book appointment with Dr. V</a></p></div>
      <div class="provider-textbox">
        <h1>Koppany Visnyei, MD PhD ( &quot;Dr. V&quot;)</h1>
        <p>&nbsp;</p>
        <h2>Specialty areas:</h2>
        <p>Internal Medicine<u></u><u></u></p>
        <p>Primary care<u></u><u></u></p>
        <p>Men’s Health<u></u><u></u></p>
        <p>Infectious diseases including HIV/AIDS<u></u><u></u></p>
        <p>STD Testing and treatment<u></u><u></u></p>
        <p>PrEP/PEP<u></u><u></u></p>
        <p>LGBTQ and Sexual health</p>
<p>&nbsp;</p>
        ...
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <p><a href="https://www.drvmedical.com/s/specialists-list-UPDATED.pdf" target="_blank" class="referralbox">Referral List</a></p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <h2>Website</h2>
        <p><a href="https://www.drvmedical.com/index.php">www.drvmedical.com</a></p>
        <p>&nbsp;</p>
        <h3>About Dr. V</h3>
        <p>&nbsp; </p>
        <div>
        ...
        <div>
          <p>Dr Visnyei (a.k.a. &ldquo;Dr V&quot;) is a board certified internist who has been serving the Beverly Hills / West Hollywood area in Los Angeles for over 5 years. He is a native of Hungary, graduated from Hannover Medical School in Germany, and worked at distinct hospitals across the globe, including the University Hospital of the University of Zurich in Switzerland and the University of Uppsala in Sweden. He got re-certified as an internist in the US at the Griffin/Yale program in Connecticut and at Beth Israel Medical Center in New York. He also has an academic background in neurosurgical sciences, neuroscience and molecular biology.</p>
          <p> </p>
        </div>
        <div>
          <p>Dr V has been working in the outpatient setting since 2013, focusing on primary care, infectious diseases, men&rsquo;s health and the gay, lesbian, transgender / LGBTQ community. Most of Dr V&rsquo;s patients are members of the LGBTQ community,  however Dr V sees a wide range of patients. Dr Visnyei is on the forefront of HIV, PrEP, Hepatitis C, other sexually transmitted diseases (STD) and other infectious diseases.</p>
        </div>
        <div>
          <p> </p>
        </div>
        <div>
          <p>Dr V is a member of the American College of Physicians, the American Academy of HIV Medicine, the Gay &amp; Lesbian Medical Association (GLMA), the Society for Neuroscience, the American Association of Cancer Research and of Collaborative Drug Discovery. Dr V has been distinguished with  several honors and awards, including the Planetree Patient Centered Care Medallion, the Award of Excellence for outstanding Performance from the Alzheimers Association, the Boehringer Ingelheim Fonds Foundation for Biomedicine Award and the Biomedical Sciences Exchange Program Scholarship Award. Dr Visnyei authored a number of peer-reviewed publications in scientific journals including Science, Cancer Research, Stem Cells and Stroke. Dr V has given countless talks both to academic and non-academic audiences nationally and internationally.</p>
          <p> </p>
          <p>For more information about Dr Visnyei&rsquo;s biography or his practice, please feel free to contact our office.</p>
        </div>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
<p>&nbsp;</p>
