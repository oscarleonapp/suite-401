...
<!-- InstanceEndEditable -->
<!-- InstanceParam name="idtag" type="text" value="home" -->
</head>
<style>
  /* CSS */
.menu {
  ...
  margin: 0;
  padding: 0;
  display: flex;               /* O para menú vertical, usa display: block; */
  gap: 1rem;
}
...
<!-- InstanceBeginEditable name="main" -->
    ...
    <!--<div class="holiday-wr">
    <div class="holiday">
      <p>&nbsp;</p>
     <h2>Holiday Schedule at Suite401Medical Office</h2>
     <p>&nbsp;</p>
      
      <div class="htable" align="center">
        <table border="0" align="center">
          <tr>
            <td width="111" bgcolor="#00BBFF">Friday, 12/23</td>
            <td width="149" bgcolor="#999999" class="open-color"><strong>OPEN TILL NOON</strong></td>
            <td width="94" bgcolor="#999999" class="open-color"><strong>Christmas</strong></td>
          </tr>
          <tr>
            <td bgcolor="#00BBFF">Monday, 12/26<span class="sup"></span></td>
            <td bgcolor="#999999"><strong>CLOSED</strong></td>
            <td bgcolor="#999999"><strong>Christmas</strong></td>
          </tr>
          <tr>
            <td bgcolor="#FFF">&nbsp;</td>
            <td bgcolor="#FFF">&nbsp;</td>
          ...
          <tr>
            <td bgcolor="#00BBFF">Friday, 12/30</td>
            <td bgcolor="#999999" class="open-color"><strong>OPEN</strong></td>
            <td bgcolor="#999999" class="open-color"><strong>New Year's&nbsp;&nbsp;</strong></td>
          </tr>
          <tr>
            <td bgcolor="#00BBFF">Monday, 01/02<span class="sup"></span></td>
            <td bgcolor="#999999"><strong>CLOSED</strong></td>
            <td bgcolor="#999999"><strong>New Year's</strong></td>
          </tr>
        </table>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
...
<!--<div class="holiday-wr">
    <div class="holiday">
      <p>&nbsp;</p>
      <p>Please note:</p>
      <h2>Our office will be 
        closed for a traning event<br />
        on October 25th, Friday.<sup></sup></h2>
      <p>Thank you,</p>
      <p>Suite401 Team</p>
    </div>
  </div>--> 
...
<!--<div class="phdown">
    <p>Please note: </p>
    <p>&nbsp;</p>
    <p><strong>Our phones are currently down.</strong>&nbsp;</p>
    <p>&nbsp;</p>
    <p>The phone company is working to fix the issue. Thank you for your patience. Please use the Patient Portal or Healow app to contact your doctor. </p>
    <p>You may also reach out to us at <b><script language="JavaScript">
var username = "Info";
var hostname = "suite401.com";
var linktext = username + "@" + hostname ;
document.write("<a href='" + "mail" + "to:" + username + "@" + hostname + "'>" + linktext + "</a>");
</script></b></p>
  </div>-->
<div class="homecont-wr">
   <!-- <div class="holiday-wr">
    <div class="holiday">
      <p>&nbsp;</p>
     <h2>2024 End of Year Schedule at Suite401Medical Office</h2>
     <p>&nbsp;</p>
      
      <div class="htable" align="center">
        <table width="771" border="0" align="center">
            <tr>
            <td width="220" bgcolor="#00BBFF"><strong>November 8, 2024</strong></td>
            <td width="114" bgcolor="#999999"><strong>CLOSED</strong></td>
            <td width="423" bgcolor="#999999"><strong>Administrative Day (office is closed)</strong></td>
          </tr>
          <tr>
            <td bgcolor="#00BBFF"><strong>November 28-29, 2024</strong></td>
            <td bgcolor="#999999"><strong>CLOSED</strong></td>
            <td bgcolor="#999999"><strong>Thanksgiving</strong></td>
          </tr>
          <tr>
            <td bgcolor="#00BBFF"><strong>December 24-25, 2024</strong></td>
            <td bgcolor="#999999"><strong>CLOSED</strong></td>
            <td bgcolor="#999999"><strong>Christmas</strong></td>
          </tr>
          <tr>
            <td bgcolor="#00BBFF"><strong>December 31, 2024</strong></td>
            <td bgcolor="#999999"><strong>CLOSED</strong></td>
            <td bgcolor="#999999"><strong>New Year</strong></td>
          </tr>
			<tr>
            <td bgcolor="#00BBFF"><strong>January 1, 2025</strong></td>
            <td bgcolor="#999999"><strong>CLOSED</strong></td>
            <td bgcolor="#999999"><strong>New Year</strong></td>
          </tr>
        </table>
  ...
  <div class="homecont">
    ...
    <div class="cont1">
      <div class="cont-textbox">
        ...
        <p>&nbsp;</p>
        <p>Access your lab results, request prescription refills, request appointments, exchange messages with our Medical Office</p>
      </div>
      <div class="buttonbox"><a class="h-patientportb" href="patientportal.php">Patient Portal</a></div>
    </div>
    <div class="cont2">
      <div class="cont-textbox">
        <h2>New Patient Registration</h2>
        <p>&nbsp;</p>
        <p>Fill out all the paperwork in advance and just walk in on your first visit.</p>
        <p>&nbsp;</p>
      </div>
      <div class="buttonbox"><a class="h-newpatientb" href="patient.php">New Patient Registration</a></div>
    </div>
      <div class="cont3">
      <div class="cont-textbox">
        <h2>Dr. V's Annual Fee Agreement</h2>
        <p>&nbsp;</p>
        <p>For patients of Dr. V: please use the link below to sign the the annual fee agreement.      </p>
        <p>&nbsp;</p>
      </div>
      <div class="buttonbox"><a class="h-newpatientb" href="drv_annual_fee_agreement.php">DrV Medical Annual Fee Agreement</a></div>
    </div>
      
  </div>
    
</div>
<div class="doctitle">Providers</div>
<div class="docs-home-wr">
  <div class="docs-home"> 
    
    <!-- A DOC -->
    <div class="adoc">
      <div class="docimg"><a href="providers-matthewmusikanth.php"><img src="images/Matthew-Musikanth-PA-C-portrait.jpg" width="100%" /></a></div>
      <div class="docname">Matthew Musikanth, PA-C</div>
    </div>
    <!-- A DOC -->
    <div class="adoc">
      <div class="docimg"><a href="providers-ruane.php#top"><img src="images/Peter-Ruane-MD.jpg" width="100%" /></a></div>
      <div class="docname">Peter J. Ruane, MD</div>
    </div>
    <!-- A DOC -->
    <div class="adoc">
      <div class="docimg"><a href="providers-trinidad.php#top"><img src="images/Kenny-Trinidad-PA-C.jpg" width="100%" /></a></div>
      <div class="docname">
        <p>Kenny Trinidad PA-C </p>
        <p><span class="smalltxt">Physician Associate<br />
          for <strong>Dr. Ruane</strong></span></p>
      </div>
    </div>
    
    <!-- A DOC -->
    <div class="adoc">
      <div class="docimg"><a href="providers-drv.php#top"><img src="images/Koppany-Visnyei-MD.jpg" width="100%" /></a></div>
      <div class="docname">
        <p>Koppany Visnyei, MD PhD</p>
      </div>
    </div>
    
    <!-- A DOC -->
    <div class="adoc">
      <div class="docimg"><a href="providers-asia-sullivan.php"><img src="images/Asia-Sullivan-PA-C_s1.jpg" width="100%
          " /></a></div>
      <div class="docname">
        <p>Asia Sullivan PA-C</p>
        <p><span class="smalltxt">Physician Associate<br />
          for <strong>Dr. V</strong></span></p>
      </div>
    </div>
      
      <!-- A DOC -->
    <div class="adoc">
      <div class="docimg"><a href="providers-jake-collins.php"><img src="images/Jake-photo-small-providers.jpg" width="100%" /></a></div>
      <div class="docname">
        <p>Jake Collins PA-C</p>
        <p><span class="smalltxt">Physician Associate<br />
          for <strong>Dr. V</strong></span></p>
      </div>
    </div>
    ...
    <!-- A DOC -->
    <div class="adoc adoclast">
      <div class="docimg"><a href="providers-wolfe.php#top"><img src="images/Peter-Wolfe-MD.jpg" width="100%" /></a></div>
      <div class="docname">Peter R. Wolfe, MD</div>
    </div>
  </div>
</div>
<div class="suite401-wr">
  <div class="suite401cont cont960">
    <div class="suite401box cont"> 
      <!--<h2>The purpose of Suite401.com is: </h2>
        <ul>
          <li>to help you navigate our medical practices </li>
          <li>to give you all the access and answers you might need to enjoy interacting with the office </li>
        </ul>-->
      <p class="mediumtxt">Building suite401.com is an ongoing process and we are improving it with your help: <a href="feedback.php">send us</a> your unanswered questions or concerns, this will help us to maximize the relevancy of the content on the site.</p>
    </div>
    <!--<div class="suite401box">
        <div class="suite401homequickb">
          <h3>FAQs </h3>
          <p> <a class="buttonwhite floatr" href="#">FAQs</a> Appointments, billing, parking... everything you might want to know. </p>
        </div>
        <div class="suite401homequickb">
          <h3>FAQs </h3>
          <p> <a class="buttonwhite floatr" href="#">Contact Info</a> Location, directions, operating hours,  parking, etc. </p>
        </div>
      </div>--> 
  </div>
</div>
