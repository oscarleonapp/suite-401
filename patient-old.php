...
<div>
  ...
  <div class="form-wr">
    <div class="formbox"><div class="introtext">
      <p><img src="images/lock.png" width="8" height="11" /> Information on this page is <strong>encrypted</strong> and will be stored on our secure servers.</p>
      <p>&nbsp;</p>
      <p>You can go <strong>back</strong> and <strong>forth</strong> between the pages using the <strong>buttons below the form</strong>.</p>
      <p>&nbsp;</p>
      <p>The form consists of <strong>6 pages</strong>, it is <strong>indicated below</strong> where you are in the process:</p></div>
      <p>&nbsp;</p>
      <!-- www.123contactform.com script begins here --> 
      <script type="text/javascript" defer src="https://www.123contactform.com/embed/1883307.js" data-role="form"></script> 
