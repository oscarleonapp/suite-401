...
<div>
  <div class="formbanner-wr">
    <div class="formbanner">
      <h1><img src="images/lockb.png" width="38" height="29" />Having trouble with the Registration Form?</h1>
    </div>
  </div>
  ...
  <div class="form-wr">
    <div class="formbox">
      <div class="introtext">
        <p>In some rare cases the registration form might not appear. This can be due to browser settings (e.g. JavaScript is disabled) or other issues.</p>
        <p>&nbsp;</p>
        <p><strong>If for any reason you are not able to fill out the registration form online, please give us a call at 323 954 1072.</strong>        </p>
        <p>&nbsp;</p>
        <p><strong>Alternatively you may send an email to us at <script language="JavaScript">
var username = "info";
var hostname = "suite401medical.com";
var linktext = username + "@" + hostname ;
document.write("<a href='" + "mail" + "to:" + username + "@" + hostname + "'>" + linktext + "</a>");
</script> and we will get back to you as soon as possible.</strong></p>
        <p>&nbsp;</p>
</div>
