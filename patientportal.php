...
<div>
<div class="portalbanner-wr">
  <div class="portalbanner">
<a class="portalbutton" href="https://health.healow.com/ruanemedical">Go to the Portal</a>  
<h1>Patient Portal</h1>
</div></div>
<div class="conttop">&nbsp;</div>
<div class="cont-wr">
  <div class="cont cont650">
    <h1>All about the <a href="https://health.healow.com/ruanemedical">Patient Portal </a></h1>
    <p>&nbsp;</p>
    <p>With the <strong>Patient Portal</strong> you can safely and securely access your LAB RESULTS, request prescription REFILLS, request APPOINTMENTS, review your STATEMENTS and exchange non-urgent MESSAGES with our Medical Office. </p>
    <p>For information on the <strong>HEALOW APP</strong> please<a href="healowapp.php"> click here</a>.</p>
    <h2>1. Getting access to the Portal</h2>
    <p>You will need a <strong>username</strong> and a <strong>password</strong> to log in to the Portal. These have been given to you on your visit to our office. If you have not received these, please call our front desk (323 954 1072) and we will set up a new username and password for you.</p>
    <h2>2. Logging in</h2>
    <p>Once you receive our automated email with your login information, you are ready to log into the portal. Go to the <a href="https://health.healow.com/ruanemedical">Portal Page </a>and log in using your username and password. (Please note: you have to activate your account within 5 days.)</p>
    <p>If this is the first time you log in, you will be asked to:</p>
    <ol>
      <li>Set up a new password (at least 8 characters) that will be easy to remember. </li>
      <li>Set up a security question in case you forget your password and need to reset it. (e.g. &quot;What is the name of your favorite teacher&quot;) </li>
    </ol>
    <h2 id="labresults">3. Using the features</h2>
    <h3>Lab results</h3>
    <p>Once your lab results have been reviewed by your doctor, he will post them to the portal. </p>
    <p>Your lab results will be published on your portal page usually within 2-3 days of the full set being available, and  depending on the test. You will get an automated email prompting you to check in to the portal to see the results. </p>
    <p>What is NOT on the portal: imaging tests results, most anatomic pathology, doctors consultations. What is on the portal is mainly lab tests (blood and urine).</p>
    <h3>Interpreting Lab results</h3>
    <p>Both normal and abnormal test results will be posted.</p>
    <p>If there is an important result, such as something requiring immediate treatment, you will hear from the office or there will be a note  attached asking you to call the office directly. Always feel free to call the office if you are worried.</p>
    <h3 id="prescriptions">Prescription Refills</h3>
    <p>Asking for a refill is easy:</p>
    <ol>
      <li>Just go to <strong>Messages</strong> &gt; <strong>Refill Requests</strong></li>
      <li>Put a checkmark next to the medication you need to be refilled.</li>
      <li>Click the orange button &quot;Refill Request&quot;</li>
      <li>Select your provider and select your pharmacy (pharmacy selection is optional)</li>
      <li>Add your notes or message in the message section and click &quot;Submit&quot;</li>
    </ol>
    <p>Please note:	Refill Requests you send are not received directly by the pharmacies. They go through our office.    </p>
    <h3>Prescription Refills Policy</h3>
    <p>We   ask that you anticipate your refill needs as early as possible and avoid last   minute requests.</p>
    <p>Our   electronic medical record system (EMR) allows your pharmacy to request refills   via computer and we have the ability to approve refills as they appear on our   terminals. These requests will be reviewed and acted upon generally within 48   hours. If you have not been seen in the office within the previous three months   it is possible that your doctor may not approve your refill and will request   that you make an appointment.</p>
    <p>Prescriptions for controlled   substances such as vicodin and other pain relievers, sleeping aids and   testosterone are monitored by regulatory agencies and more frequent visits are   required for your doctor to monitor you and assess whether it is appropriate for   you are to remain on these medications.</p>
    <p>&nbsp;</p>
<h3 id="messages">Messages</h3>
    <p>You can exchange <span class="highlight">simple, non-urgent messages</span> with the office and your doctor using the Portal or <a href="healowapp.php">Healow App</a> on your phone. </p>
    <p>Messages you send, including those directed to your doctor, will be received initially in the in-box of a Medical Assistant who will process/forward the message. </p>
    <p>Messages received after 4PM will be processed the next business day. </p>
    <p>Please avoid very long messages or answers to complex questions. Such messages should be either an office visit or phone call. </p>
    <p>If your doctor is away, depending on content, the message may be kept until he or she returns. If you don’t hear back within the expected timeframe, please contact the office directly.<br />
    </p>
    <h3>Appointments</h3>
    <p>You have the option to ask for an appointment to see your doctor.</p>
    <ol>
      <li>Go to <strong>Appointments</strong> &gt; <strong>New Appointment</strong></li>
      <li>Select your provider and the date range that would work for you (please note: the earliest you can schedule is 4 business days from the day of scheduling)</li>
      <li>Click &quot;Submit&quot;</li>
    </ol>
    <p>The request will be received by our front desk and they will get back to you about the exact date and time they can schedule you (the system does not allow yet you to directly schedule yourself).</p>
    <p>&nbsp;</p>
    <h2 id="loginfaqs">4. FAQs</h2>
    <h3>Why am I getting an error message when I try to log in?</h3>
    <p>If you can not log in with your credentials, please consider the following:</p>
    <ul>
      <li>Even though you have been provided a user name and temporary password by the office, the portal for you only becomes active after the system has sent you a confirmatory email. This can take up to an hour. Don't try to log on until you have received this confirmatory email.</li>
      <li>If you have already logged in earlier, please remember that you have set up a new password. The password you received from us initially was a temporary password which you had to change the first time you logged in. </li>
      <li>Have you logged in within 72 hours after receiving the initial login information? Your initial/temporary password becomes inactive after 72 hours for security consideration. If this happened, please contact us and we will set a new password for you. (Please note: unlike the temporary password, the password you set up for yourself after the first login does not have a time limit, so the 72-hour limit only applies for the first login).</li>
    </ul>
    <p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
...
document.write("<a href='" + "mail" + "to:" + username + "@" + hostname + "'>" + linktext + "</a>");
      ...
      <p><span class="contactd"><img src="images/phone-f.png" alt="Call us" width="23" height="14" />Phone</span>&nbsp;Dr. Peter Ruane, Dr. Peter Wolfe, Kenny Trinidad PA-C: <a href="tel:+13239541072"> 323.954.1072 </a> | Research Dept.: <a href="tel:+13239540400">323.954.0400 </a> | FibroScan: <a href="tel:+13107105220">310.710.5220</a> </p>
