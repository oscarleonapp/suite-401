...
<div>
  ...
  <div class="form-wr">
    <div class="formbox">
      <div class="introtext">
        <p><img src="images/lock.png" width="8" height="11" /> E<strong>ncrypted page</strong></p>
        <p>&nbsp;</p>
        <p>Form should appear below:</p>
        <p class="formnotshowing">(If the form does not appear within 10 seconds or any other issue, please <a href="patient-formnotshowing.php" target="_blank">click here</a>.)</p>
      </div>
<!-- www.123formbuilder.com script begins here --><script type="text/javascript" defer src="https://www.123formbuilder.com/embed/4665521.js" data-role="form" data-default-width="650px"></script><!-- www.123formbuilder.com script ends here -->
      <p>&nbsp;</p>
    </div>
  </div>
</div>
