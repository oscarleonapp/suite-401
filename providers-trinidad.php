...
<title>Kenny Trinidad PA-C | Medical Office</title>
<!-- InstanceEndEditable -->
...
<div>
  <div class="providerprofile-wr">
    <div class="providerprofile">
      <div class="provider-imgbox"><img src="images/Kenny-Trinidad-PA-C.jpg" width="100%" />
      <!--<p><a class="acceptedins" href="#">Accepted Health Plans</a>      </p>--><p><a class="book-but" href="appointment.php#top">Request appointment with Kenny Trinidad PA-C</a></p></div>
      <div class="provider-textbox">
        <h1>Kenny Trinidad, MPAP, PA-C</h1>
        <p>&nbsp;</p>
        <h2>Specialty areas:</h2>
        <ul>
          <li>Men's Health </li>
          <li>Men's sexual health and STDs </li>
          <li>PrEP </li>
          <li>HIV/AIDS </li>
        ...
        <p>&nbsp;</p>
<p>&nbsp;</p>
        <p><a href="https://ruanemedical.sharepoint.com/:x:/s/Referrals/ES9GBQUKKSRKhmCeysCtalQBrtyoBuJgU43ooaPDlEZLsA?e=gH3aFp" target="_blank" class="referralbox">Referral List</a></p>
        <p>&nbsp;</p> 
        <p>&nbsp;</p>
        <h2>Accepting new patients: </h2>
        <p><strong>Yes</strong></p>
        <p>&nbsp;</p>
        <p>Kenny Trinidad, a Los Angeles native, joined us in 2015 to dedicate all his time to the patients of our practice, focusing on HIV prevention and Men's Health. Kenny has been sought out by our organization not only for his clinical skills but because of his patient focused and caring approach, his attention to detail, and his personable manner he displays with patients.</p>
        <p>&nbsp;</p>
        <p>Practicing what he preaches to his patients, Kenny maintains an active and health-conscious lifestyle by playing competitive tennis and doing yoga and hiking regularly.</p>
        <p>&nbsp;</p>
<p>Kenny earned his Master of Physician Assistant Practice degree at the Keck School of Medicine of USC in 2005 and his Bachelors degree in Physiological Sciences at UCLA in 2000.</p>
<p>&nbsp;</p><iframe width="560" height="315" src="https://www.youtube.com/embed/dpPEF4arIIE" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
<p>&nbsp;</p>
