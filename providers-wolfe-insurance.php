...
<title>Insurance | Peter R. Wolfe, MD | Suite 401</title>
<!-- InstanceEndEditable -->
  ...
  <div class="providerprofile-wr">
    <div class="providerprofile">
      <div class="provider-imgbox">
        <p><img src="images/provider-wolfe.gif" width="100%" /></p>
        <p><a class="book-but" href="appointment.php#top">Request appointment with Dr. Wolfe</a></p>
      </div>
      <div class="provider-textbox">
        <h1>Insurance that Dr. Wolfe accepts in his practice</h1>
        <p>&nbsp;</p>
        <h3>United Healthcare (PCP) Infectious Disease Specialist</h3>
        <p>
          1-PPO<br />
          2-Select Plus<br />
          3-Select<br />
          ...
          5-Choice Plus</p>
        <h3><br />
          Anthem Blue Cross (Internal Medicine-Infectious Disease)</h3>
        <p>
          1-PPO<br />
          2-Coverage California-is the umbrella of following plans<br />
          (Pathway EPO)<br />
          (Platinum)<br />
          (Silver)<br />
          (Direct Acess)<br />
        ...
        <p>
          1-PPO<br />
          2-Open Acces Plus<br />
          3-Local Plus<br />
        </p>
        <p>&nbsp;</p>
        <h3>Blue Shield eff. 03/12/12 (Internal Medicine-Infectious Disease)</h3>
        <p>
          1-PPO<br />
          2-Coverage California eff. 01/01/13<br />
          3-EPO eff. 01/01/15</p>
        <h3><br />
          First Health Network</h3>
        <p>
          1-PPO</p>
        <h3><br />
          PHCS-Multiplan</h3>
        <p>PHCS-Multiplan</p>
        <h3>
          Humana (Specialist-Infectious Disease)</h3>
        <p>
          1-Choice Care PPO<br />
          2-Medicare PPO<br />
        </p>
        <p>&nbsp;</p>
        <h3>Medicare-Noridian<br />
        </h3>
        <p>Medicare-Noridian<br />
        </p>
        <h3>Aetna</h3>
        <p>
          1-PPO<br />
