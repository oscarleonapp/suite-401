...
<title>Peter J. Ruane MD | Medical Office</title>
<!-- InstanceEndEditable -->
...
<div>
  <div class="providerprofile-wr">
    <div class="providerprofile">
      <div class="provider-imgbox"><img src="images/Peter-Ruane-MD.jpg" width="100%" />
      <!--<p><a class="acceptedins" href="#">Accepted Health Plans</a>      </p>--><p><a class="book-but" href="appointment.php#top">Request appointment with Dr. Ruane</a></p></div>
      <div class="provider-textbox">
        <h1>Dr. Peter Ruane, MD</h1>
        <p>&nbsp;</p>
        <h2>Specialty areas:</h2>
        <p>Internal Medicine and Infectious Diseases</p>
        <p>&nbsp;</p>
        <h2>Accepting new patients: </h2>
        <p><strong>Yes</strong></p>
        <p>&nbsp;</p>
        <p>Dr. Peter Ruane is a practicing physician with over 30 years experience. Born and raised in Ireland, he earned his Medical Degree from University College Dublin.</p>
        <p>&nbsp;</p>
        <p>Dr. Ruane completed his internal medicine residency at Mayo Clinic (Rochester, Minnesota) before becoming Board Certified in Infectious Diseases during his research and clinical fellowship at the West Los Angeles Veterans Affairs Medical Center.</p>
        <p>&nbsp;</p>
        <p>With twenty-five years of experience diagnosing and treating complex HIV related infections with the best antiviral therapies, Dr Ruane expanded his expertise with clinical trial research, developing new treatments for another major RNA virus:  Hepatitis C.</p>
        <p>&nbsp;</p>
        <p>Treating a large spectrum of patients, Dr Ruane provides the most up to date treatments available, as well as access to ongoing and upcoming clinical trials with leading pharmaceutical companies. All patients are welcome to apply for trial participation.</p>
<p>&nbsp;</p>
